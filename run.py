...
max_angle = 40  # Maximum steering angle
    ...
    try:
        ...
        while True:
            ...
            if left_lane is not None and right_lane is not None:
                ...
                print(f"Lane following: error={error}, steering={steering}")
            else:
                # If no lanes detected, slow down
                px.set_dir_servo_angle(0)
                px.forward(speed // 2)
                print("No lanes detected, slowing down")
...
if __name__ == "__main__":
    ...
    choice = input("Select mode (1: Drive Car, 2: Test Lane Detection): ")
